...
class Project(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Project")
        ...
        self.center_freq = center_freq = 105e6
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(24, firdes.low_pass(1, samp_rate, 100e3, 10e3, window.WIN_HAMMING, 6.76), 1)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'raw_iq.dat', False)
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.filter_fft_low_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq  , (self.samp_rate/24 ))
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0, (self.samp_rate/24))
...
def main(top_block_cls=Project, options=None):
